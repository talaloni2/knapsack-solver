...
async def test_solution_reports_waiter(cause: SolutionReportCause, redis_client: Redis, channel_prefix: str, knapsack_id: str, solution_reports_channel_name: str):
